...
export function setFormatTime(t, date) {
...
/**
 * 解析下载响应、默认从响应头截取名称+后缀
 * @param res
 * @param fileName 文件名
 * @param suffix 后缀名
 */
export function analyzeDown(res, fileName, suffix = "") {
  ...
  if (!fileName) {
    ...
    fileName = window.decodeURI(fileName.split(";")[1].split("filename=")[1]);
  }
